...
#                   _model.random_b: zeros1b})
    ...
    z_meana, z_stddeva, recon_mesha = _model.sess.run(
        [_model.z_mean_a, _model.z_stddev_a, _model.generated_mesh_test_a],
        feed_dict={_model.inputs_a: _model.feature_a, _model.random_a: zeros1a})
    
    recon_fva = utils.recover_data(recon_mesha, _model.logrmin_a, _model.logrmax_a, _model.smin_a, _model.smax_a, vcgan.resultmin,
                             vcgan.resultmax)
...
#    f.close()
    ...
    sio.savemat(vcgan.logfolder + '/test_vae/' + 'recon_a' + str(step + 1) + '.mat', {
            'latent_mean': z_meana,
...
#    print(fv1.shape)
    ...
    name = vcgan.logfolder + '/_recon/' + 'recover_' + str(step+1) + '.h5'
